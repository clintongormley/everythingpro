    ...
    `}_renderLiveGrid(){const t=this._getRoomBounds(),e=t.minCol>t.maxCol,i=e?0:t.minCol,o=e?19:t.maxCol,r=e?0:t.minRow,n=e?19:t.maxRow,s=o-i+1,a=n-r+1,l=Math.min(480,.55*(this.offsetWidth||800)),d=Math.min(Math.floor(l/s),Math.floor(l/a),32);return O`
      ...
      <div class="targets-overlay" style="pointer-events: none;">
        ${this._targets.map((t,e)=>{if(!t.active)return V;const o=this._mapTargetToGridCell(t);if(!o)return V;const n=(o.col-i)/s*100,l=(o.row-r)/a*100;return O`
            <div
              class="target-dot"
              style="left: ${n}%; top: ${l}%; background: ${Dt[e]||Dt[0]};"
            ></div>
    ...
    `:V}_renderUncalibratedFov(){const t=this._sensorState.occupancy,e=t?"#4CAF50":"var(--primary-color, #03a9f4)",i=150,o=10,r=180,n=30*Math.PI/180,s=150*Math.PI/180,a=i+r*Math.cos(n),l=o+r*Math.sin(n),d=i+r*Math.cos(s),c=o+r*Math.sin(s);return O`
      <div style="display: flex; flex-direction: column; align-items: center; padding: 24px;">
        <svg viewBox="0 0 300 210" width="300" height="210" style="display: block;">
          ...
          <!-- Target dots -->
          ${this._targets.map((t,e)=>{if(!t.active)return V;const n=Math.sqrt(t.raw_x*t.raw_x+t.raw_y*t.raw_y),s=Math.atan2(t.raw_x,t.raw_y),a=Math.min(n/6e3,1)*r,l=Math.PI/2+s,d=i+a*Math.cos(l),c=o+a*Math.sin(l);return Z`<circle cx="${d}" cy="${c}" r="5" fill="${Dt[e]||Dt[0]}"/>`})}
          ...
          <div style="flex: 1; min-width: 0;">
            ...
            <div class="targets-overlay" style="pointer-events: none;">
              ${this._targets.map((t,e)=>{if(!t.active)return V;const o=this._mapTargetToGridCell(t);if(!o)return V;const n=(o.col-i)/s*100,l=(o.row-r)/a*100;return O`
                    <div
                      class="target-dot"
                      style="left: ${n}%; top: ${l}%; background: ${Dt[e]||Dt[0]}; opacity: ${t.pending?.3:1}; transition: opacity 0.5s ease;"
                    ></div>
