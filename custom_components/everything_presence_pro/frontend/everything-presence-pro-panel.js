      ...
      <div class="zone-item-row zone-settings-row" style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;">
        <div style="width: 100%; display: flex; align-items: center; gap: 4px;">
          ...
          <select
            class="sensitivity-select" style="flex: 1; min-width: 0;"
            .value=${t.type}
            @change=${i=>{const o=i.target.value,r=yt[o]||yt.normal,n=[...this._zoneConfigs];n[e]={...t,type:o,trigger:r.trigger,renew:r.renew,timeout:r.timeout,transfer_timeout:r.transfer_timeout},this._zoneConfigs=n,this._dirty=!0}}
            @click=${t=>t.stopPropagation()}
          >
            <option value="normal">Normal</option>
            <option value="entrance">Entrance</option>
    ...
    `}_renderFurnitureOverlay(t,e,i,o,r){if(!this._furniture.length)return V;const n=Math.ceil(this._roomWidth/Tt),s=Math.floor((St-n)/2),a=t+1,l="furniture"===this._sidebarTab;return O`
      <div class="furniture-overlay ${l?"":"non-interactive"}">
        ${this._furniture.map(o=>{const r=(s-e)*a+this._mmToPx(o.x,t),n=(0-i)*a+this._mmToPx(o.y,t),l=this._mmToPx(o.width,t),d=this._mmToPx(o.height,t),c=this._selectedFurnitureId===o.id;return O`
            ...
            >
              ${"svg"===o.type&&_t[o.icon]?Z`<svg viewBox="${_t[o.icon].viewBox}" preserveAspectRatio="none" class="furn-svg">
                    ${xt(_t[o.icon].content)}
